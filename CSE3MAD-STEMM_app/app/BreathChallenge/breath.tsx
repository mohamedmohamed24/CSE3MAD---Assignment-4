...
const INSTRUCTIONS = [
  ...
  "Perform light exercise (jog 1 minute or 100 star jumps)",
  "Record breathing again and compare results",
  "Analyze how exercise affects breathing rate",
...
const styles = StyleSheet.create({
  ...
  footer: {
    ...
    right: 0,
    padding: 20,
    backgroundColor: "rgba(247, 248, FA, 0.9)", // Slight blur effect
  },
  startButton: {
    backgroundColor: "#FF5A00",
    borderRadius: 12,
