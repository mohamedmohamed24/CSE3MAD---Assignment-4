...
const INSTRUCTIONS = [
  "Phase 1: Tap the screen as soon as the button appears, record reaction time",
  "Phase 2: Repeat using the non-dominant hand",
  "Phase 3: Trace a moving shape on the screen",
  "Rotate through each team member for each phase",
  "Compare results and analyze improvement",
];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "black" }} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Neuroscience + Mathematics</Text>
      </View>
      ...
      >
        ...
        <View style={styles.overviewCard}>
          ...
          <Text style={styles.overviewText}>
            Students measure reaction time, coordination, and improvement
            through repeated digital and physical challenges.
          </Text>
        </View>
