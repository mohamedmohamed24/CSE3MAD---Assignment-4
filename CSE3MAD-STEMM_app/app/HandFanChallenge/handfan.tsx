...
const INSTRUCTIONS = [
  "Phase 1: Test different fan designs at 30cm distance",
  "Phase 2: Test the same fan at different distances (15cm, 30cm, 45cm)",
  "Phase 3: Test different paper types (regular paper, cardboard, tissue)",
  "Record bend angle for each test",
      ...
      >
        ...
        <View style={styles.overviewCard}>
          ...
          <Text style={styles.overviewText}>
            Students test how air movement affects flexible materials by
            creating different fan designs and measuring paper bend angles
            across three phases.
          </Text>
        </View>
